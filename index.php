...
<body>
  <div class="container-fluid">
    <div class="row my-2">
        <div class="col-md">
            <h3 class="bg-dark text-white text-center fw-bold text-uppercase" style="padding:20px;">Welcome to DataTable</h3>
            <hr>
        </div>
    </div>
    <div class="row">
    ...
    <footer class="bg-dark text-white text-center" style="padding:5px;bottom: 0;position: fixed;width: 100%;height: 50px;line-height: 40px">
        <p>ReCreated With <i class="bi bi-suit-heart-fill" style="color: red;"></i> by Alif F Hakim</p>
    </footer>
    <!-- Close Footer -->
  ...
  <script type="text/javascript">
    ...
    $(document).on('submit', '#addUser', function(e) {
      ...
      if (city != '' && username != '' && mobile != '' && email != '') {
        ...
        alert('Silahkan isi semua datanya dulu');
      }
    });
